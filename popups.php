        ...
        <div class="sdiv">
            <form action="" class="settings" method="post" enctype="multipart/form-data">
                ...
                <div class="ssbuttons">
                    <a href="edituser.php">
                        <div class="inbtn">
                             <input type="submit" formaction="edituser.php" style="all:unset" name="submit" value="Edit Basic Information">
                        </div>
                    </a>
                    <a href="editpass.php">
                        <div class="inbtn">
                             <input type="submit" formaction="editpass.php" style="all:unset" name="submit" value="Change Password">
                        </div>
                    </a>
                    ...
                    <a href="logout.php">
                        <div class="inbtn">
                            <input type="submit" formaction="logout.php" style="all:unset" name="submit" value="Log Out">
                        </div>
                    </a>
                </div>
            </form>
