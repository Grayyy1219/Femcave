            ...
            <div class="nav">
                <a href="Landing page.php">
                    <div id="asd">
                        ...
                        <h2 class="Swiftie Shopper">Femcave</h2>
                    </div>
                </a>
            </div>
        </div>
            ...
            <div class="create-acxount-bg">
                <form action="" class="loginsignup" method="post" enctype="multipart/form-data"
                    ...
                    <div class=" login">
                        ...
                        <div class="password">
                            <input class="input" placeholder="Password" type="password" name="txtpassword" id="password"
                                required />
                            <img class="img-2" src="img/lock.svg" />
                        </div>
                        <div class="confirm">
                            <input class="input" placeholder="Confirm Password" type="cpassword" name="txtcpassword"
    ...
    <footer>
        <div class="footer">
            <div class="all-footer">
                ...
                <div class="div-2">
                    <div class="text-wrapper-3">ABOUT Femcave</div>
                    <div class="frame-2">
            ...
            <div class="div-dmgodq">
                <p class="p">COPYRIGHT 2023 © Femcave</p>
            </div>
        </div>
    </footer>
