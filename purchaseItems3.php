...
$getSelectedItemsQuery = "SELECT ItemID, ItemName, ItemImage, Quantity, Price FROM items WHERE ItemID = ?";
...
$getProductQuery = "SELECT * FROM items WHERE ItemID = '$selectedItems' LIMIT 1";
...
if ($Quantity > $availableQuantity) {
    ...
    echo "<a href='Landing page.php' style='text-decoration: none; color: #ff6b81; font-size: 30px; display: block; margin-top: 10px;'>Home</a>";
    echo "</div>";
    exit();
}
?>
